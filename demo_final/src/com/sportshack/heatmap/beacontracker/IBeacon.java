...
public class IBeacon implements Serializable{
	 ...
	 */
	public IBeacon(byte[] uuid, int major, int minor, float proximity){
		_uuid = uuid;
		_major = major;
		_minor = minor;
	...
	public void setTxPower(float _txPower) {
	...
	public void setProximity(float _proximity) {
	...
	public void setPowerValue(float _powerValue) {
	...
	public void set_rssi(float _rssi) {
		this._rssi = _rssi;
	}
